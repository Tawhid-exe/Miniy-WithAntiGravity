                    ...
                    <div className="flex items-center gap-4">
                        ...
                        {isAuthenticated ? (
                            <motion.div
                                ...
                                whileTap={{ scale: 0.95 }}
                                onClick={logout}
                                className="cursor-pointer flex items-center gap-2 px-4 py-2 rounded-full text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all"
                            >
                                <User size={20} />
