...
import { adminAddProduct, adminUpdateProduct, adminDeleteProduct, adminFetchProducts, adminFetchBmsCategories } from '../../services/appsScript';
...
function AdminProducts() {
    ...
    const loadProducts = async () => {
        setLoading(true);
        try {
            const [data, bmsCats] = await Promise.all([
                adminFetchProducts(),
